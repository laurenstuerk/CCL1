...
class BaseGameObject {
    ...
    physicsData = {
        ...
        "jumpForceDecay": 2,
        "isGrounded": false,
        "remainingJumps": 0, // Allows double jump by default
        "maxJumps": 0,        // Maximum number of jumps
    }
    ...
    applyGravity = function () {
        ...
        if (this.physicsData.jumpForce > 0) {
            ...
            this.physicsData.jumpForce -= this.physicsData.jumpForceDecay * global.deltaTime * 5;
    ...
    setJumpForce = function (jumpForce) {
        ...
        if (this.physicsData.isGrounded || this.physicsData.remainingJumps > 0) {
            ...
            if (this.physicsData.remainingJumps < 0) {
                this.physicsData.remainingJumps = 0;
            }
        }
    };
